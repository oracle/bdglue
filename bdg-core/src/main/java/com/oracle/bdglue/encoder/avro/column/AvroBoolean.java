/* ./src/main/java/com/oracle/bdglue/encoder/avro/column/AvroBoolean.java 
 *
 ...
 *
 */
public class AvroBoolean extends AvroColumn {
    AvroBoolean(DownstreamColumnMetaData meta) {
        super(meta);
        setColumnType();
    }
    ...
    protected void setColumnType() {
        super.columnType = AvroColumnType.BOOLEAN;
        super.avroSchemaType = Schema.Type.BOOLEAN;
    }
     ...
     * @return an instance of type Boolean that will be added 
     * to the Avro-encoded data stream.
     */
    @Override
    public Boolean encodeForAvro(DownstreamColumnData col) {
        
        return Boolean.valueOf(col.asBoolean());
    }
}
